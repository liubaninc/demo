...
bool isDebug = !const bool.fromEnvironment("dart.vm.product");
...
class _WebViewTabState extends State<WebViewTab> with WidgetsBindingObserver {
          ...
          Wrap(
            children: [
              GestureDetector(
                ...
                child: Container(color: Colors.red, padding: const EdgeInsets.all(15), child: const Text('init')),
              ),
              const SizedBox(
                width: 20,
                height: 20,
              ...
              GestureDetector(
                ...
                child: Container(color: Colors.red, padding: const EdgeInsets.all(15), child: const Text('startScan')),
              ),
              const SizedBox(
                width: 20,
                height: 20,
              ...
              GestureDetector(
                ...
                child: Container(color: Colors.red, padding: const EdgeInsets.all(15), child: const Text('stopScan')),
              ),
              const SizedBox(
                width: 20,
                height: 20,
              ...
              GestureDetector(
                onTap: () {
                  BleUtil.instance.connect('A4:C1:38:70:2F:20');
                },
                child: Container(color: Colors.red, padding: const EdgeInsets.all(15), child: const Text('connect')),
              ),
            ],
          ),
        ],
  ...
  InAppWebView _buildWebView() {
    ...
    return InAppWebView(
      ...
      // initialFile: isDebug ? 'assets/htmls/test_html.html' : null,
      // initialUrlRequest: isDebug ? null : URLRequest(url: widget.webViewModel.url),
        ...
        if (favicons != null && favicons.isNotEmpty) {
          for (var fav in favicons) {
            if (widget.webViewModel.favicon == null) {
              ...
              if ((widget.webViewModel.favicon!.width == null && !widget.webViewModel.favicon!.url.toString().endsWith("favicon.ico")) ||
                  (fav.width != null && widget.webViewModel.favicon!.width != null && fav.width! > widget.webViewModel.favicon!.width!)) {
                widget.webViewModel.favicon = fav;
              }
            }
          }
