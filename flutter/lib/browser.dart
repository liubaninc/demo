...
class _BrowserState extends State<Browser> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    getIntentData();
    JPushUtil.instance.initPlatformState();
  }
            ...
            body: TabViewer(
              ...
              children: browserModel.webViewTabs.map((webViewTab) {
                ...
                var faviconUrl = webViewTab.webViewModel.favicon != null
                    ...
                    : (url != null && ["http", "https"].contains(url.scheme) ? Uri.parse("${url.origin}/favicon.ico") : null);
                ...
                return Column(
                  ...
                  children: <Widget>[
                    Material(
                      color: isCurrentTab ? Colors.blue : (webViewTab.webViewModel.isIncognitoMode ? Colors.black : Colors.white),
                      child: ListTile(
                        leading: Column(
